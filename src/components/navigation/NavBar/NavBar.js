...
//                     <img width="150px" src={amuEval} alt="amu eval"/>
//                     {navOptionsVisible && (
//                     <>
//
//                     <FlexRow as="ul" className="NavbarStyle__links" gap="40px">
...
//                             <button className="NavbarStyle__sign_in_btn">Sign in</button>
//                         </FlexRow>
//                     )}
//                     </>
//                     )}
