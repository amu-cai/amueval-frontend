...
const TableRowItems = ({ orderedKeys, item, i, subpage, users, setRightsUpdateResult }) => {
  const renderValue = (keyValue, additionalMetricName = null, setRightsUpdateResult = null) => {
  ...
  const renderItem = (keyValue, additionalMetricName, setRightsUpdateResult) => {
    return renderValue(keyValue, additionalMetricName, setRightsUpdateResult);
  };
