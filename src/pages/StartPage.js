...
const StartPage = () => {
  ...
  return (
    <StartPageStyle>
      <H1 margin="0 0 20px 0" color={theme.colors.white}>Widok i edycja dokumentu PDF</H1>
      <FlexRow className='StartPage__document-input'>
        <Svg backgroundColor={theme.colors.white} src={fileImage} width="40px" height="40px" />
        <label htmlFor={id}>
          Otwórz dokument
        </label>
        <input
      ...
      <Svg backgroundColor={theme.colors.white} src={shipImage} width="500px" height="490px" margin="0 0 0 auto" />
